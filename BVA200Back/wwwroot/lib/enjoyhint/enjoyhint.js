...
(function(factory){
  ...
  var EnjoyHint = function(configs) {
    ...
    var stepAction = function() {
      ...
      var scrollSpeed = 0;//step_data.scrollAnimationSpeed;
      ...
      setTimeout(function() {
        ...
        setTimeout(function() {
          ...
          if (!step_data.event_type && step_data.event == "select") {
          ...
          if (!step_data.event_type && step_data.event == "click") {
          ...
          if (!step_data.event_type && step_data.event == "wait") {
